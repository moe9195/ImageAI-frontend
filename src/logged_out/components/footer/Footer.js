...
function Footer(props) {
  ...
  return (
    <footer className="lg-p-top" style={{ background: "#0e141d" }}>
      <WaveBorder
        upperColor="#0e141d"
      ...
      <div className={classes.footerInner}>
        <Grid container spacing={isWidthUp("md", width) ? 10 : 5}>
              ...
              <Box display="flex" flexDirection="column">
                <Box mb={1}>
                  <TextField
                    ...
                    style={{
                      border: "1px solid rgba(0,233, 241, 0.5)",
                      borderRadius: "4px",
                    }}
                    rows={4}
                    fullWidth
          ...
          <Grid item xs={12} md={6} lg={4}>
            ...
            <Typography style={{ color: "#00E9F1" }} paragraph>
